...
class UDADecorator(BaseSegmentor):
    ...
    def instance_similarity_loss(self, sim_w, sim_s):
        """Calculate instance similarity loss"""

        return self.get_model().instance_similarity_loss(sim_w, sim_s)
    ...
    def cal_instance_similarity(self, emb_tw, emb_ts):
        ...
        return self.get_model().cal_instance_similarity(emb_tw, emb_ts)
    
    def forward_feature_embedding(self, img):
        '''Obtaining feature map of input images'''

        return self.get_model().forward_feature_embedding(img)
