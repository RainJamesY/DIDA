...
class EncoderDecoder(BaseSegmentor):
    ...
    def forward_train(self,
        ...
        # resize into a semantic segmentation map of the same size as input
        ...
        pdb.set_trace()
        # seg_labels = gt_semantic_seg.squeeze(1) # seg_labels.shape: [2, 512, 512]
        
        '''Averaging the x_feat to 19 instance-features'''
        
        self.instance_feature_avg(x_feat, gt_semantic_seg, device=dev)

        pdb.set_trace()


        # In semantic segmentation, the extracted features 
        # don't just go through a FC-head
        losses = dict()
